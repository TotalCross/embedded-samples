...
<div align="center"> 
<h1> Bad Apple Sample </h1> </div>
<p align="center">code sample showing performance when running bad apple animation at 60 fps </strong></em></p>
...
- If you are using Linux, run `code <embedded-samples>` or open VS Code and Click in "File > Open..." and select embedded-samples/bad-apple in the file dialog that will be shown.
- With project opened in VS Code, navigate to BadApple aplication.
- Look for its `RunBadAppleTCApplication.java.java` and right-click.
