...
public class DoorBell extends Container {
    ...
    private Label title;
    private Label fDoor;
    private Label fDMontion;
    private Label fDLDing;
    private Label fDLMotion;
    private Label fDEstado;
    private Label fDMEstado;
    private Label fDLDtempo;
    private Label fDLMtempo;

    private Icon fDoorIcon;
    private Icon fDMIcon;
    private Icon fDLDIcon;
    private Icon fDLMoIcon;
