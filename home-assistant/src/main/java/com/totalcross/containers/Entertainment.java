...
public class Entertainment extends Container {
    ...
    private Label title, atividade, comutadorHDMI, entradaHDMI, volume, tempTV, desligarTV, txtDevice, txtAtiv,
            txtTempTV;
    private String[] services = { "PowerOFF", "Watch Fire TV", "YouTube", "SATV", "Watch Apple TV" };
    private String[] comutHDMI = { "AppleTV", "FireTV", "Shield" };
    private String[] entHDMI = { "imputHDMI1", "imputHDMI2", "imputHDMI3", "imputHDMI4" };
    private Slider vol;
    private Button desl;
    private ComboBox actiBox, comutBox, enterBox;
    private Icon ativIcon, comutIcon, entIcon, volIcon, temptvIcon, desligarIcon;
    private ImageControl imgHarmony;
