...
<div align="center"> 
<h1> Home appliance sample application </h1> </div>
...
- If you are using Linux, run `code <embedded-samples>` or open VS Code and Click in "File > Open..." and select embedded-samples/HomeApplianceXML in the file dialog that will be shown.
- With project opened in VS Code, navigate to desired sample folder (like HomeApplianceXML).
- Look for its `HomeApplianceXMLApplication.java` and right-click.
